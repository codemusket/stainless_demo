...
```sh
npm install git+ssh://git@github.com:codemusket/stainless_demo.git
```
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/codemusket/stainless_demo/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/codemusket/stainless_demo/issues) with questions, bugs, or suggestions.
